...
class Dynamic_menu
{
  ...
  function build_menu($id, $nama)
  {
    ...
    $query = $this->ci->db->query("SELECT a.title,a.id,b.show_menu FROM dyn_groups a,user_dyn_menu b where a.id=b.id AND b.show_menu = '1' AND b.user_id='$id' ORDER BY urut ASC");
    ...
    $html .= '<ul class="right">
          <li class="has-dropdown">
            <a href="#">Welcome,<b>' . $nama . '</b></a>
            <ul class="dropdown">';
    // Remark versi menu admin Sunu

    if ($id == 1 || $id == 609 || $id == 610 || $id == 611) {
    ...
    $html .= '<li><a href=' . base_url("index.php/admin/GantiPassword") . '>Ganti Password</a></li>
