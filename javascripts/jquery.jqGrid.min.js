...
"="+i[l]))}return'<tr role="row" id="'+d+'" tabindex="'+h+'" class="'+e+'"'+(c===""?"":' style="'+c+'"')+j+">"},y=function(d,c,e,f,g){var i=new Date,h=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="xmlstring",j=b.p.xmlReader,l=b.p.datatype==="local"?"local":"xml";if(h){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(a.isXMLDoc(d)){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var m=a(b),k,o,n=0,p,y=b.p.multiselect===true?1:0,x=0,K,G=b.p.rownumbers===
true?1:0,u,C=[],H,A={},F,D,M=[],B=b.p.altRows===true?b.p.altclass:"",Q;if(b.p.subGrid===true){x=1;K=a.jgrid.getMethod("addSubGridCell")}j.repeatitems||(C=t(l));u=b.p.keyIndex===false?a.isFunction(j.id)?j.id.call(b,d):j.id:b.p.keyIndex;if(C.length>0&&!isNaN(u)){b.p.remapColumns&&b.p.remapColumns.length&&(u=a.inArray(u,b.p.remapColumns));u=C[u]}l=(""+u).indexOf("[")===-1?C.length?function(b,d){return a(u,b).text()||d}:function(b,d){return a(j.cell,b).eq(u).text()||d}:function(a,b){return a.getAttribute(u.replace(/[\[\]]/g,
""))||b};b.p.userData={};b.p.page=a.jgrid.getXmlData(d,j.page)||b.p.page||0;b.p.lastpage=a.jgrid.getXmlData(d,j.total);if(b.p.lastpage===void 0)b.p.lastpage=1;b.p.records=a.jgrid.getXmlData(d,j.records)||0;a.isFunction(j.userdata)?b.p.userData=j.userdata.call(b,d)||{}:a.jgrid.getXmlData(d,j.userdata,true).each(function(){b.p.userData[this.getAttribute("name")]=a(this).text()});d=a.jgrid.getXmlData(d,j.root,true);(d=a.jgrid.getXmlData(d,j.row,true))||(d=[]);var E=d.length,z=0,N=[],P=parseInt(b.p.rowNum,
10),L=b.p.scroll?a.jgrid.randId():1;if(E>0&&b.p.page<=0)b.p.page=1;if(d&&E){g&&(P=P*(g+1));var g=a.isFunction(b.p.afterInsertRow),S=false,X;if(b.p.grouping){S=b.p.groupingView.groupCollapse===true;X=a.jgrid.getMethod("groupingPrepare")}for(;z<E;){F=d[z];D=l(F,L+z);D=b.p.idPrefix+D;k=e===0?0:e+1;Q=(k+z)%2===1?B:"";var J=M.length;M.push("");G&&M.push(s(0,z,b.p.page,b.p.rowNum));y&&M.push(r(D,G,z,false));x&&M.push(K.call(m,y+G,z+e));if(j.repeatitems){H||(H=v(y+x+G));var O=a.jgrid.getXmlData(F,j.cell,
true);a.each(H,function(a){var d=O[this];if(!d)return false;p=d.textContent||d.text;A[b.p.colModel[a+y+x+G].name]=p;M.push(q(D,p,a+y+x+G,z+e,F,A))})}else for(k=0;k<C.length;k++){p=a.jgrid.getXmlData(F,C[k]);A[b.p.colModel[k+y+x+G].name]=p;M.push(q(D,p,k+y+x+G,z+e,F,A))}M[J]=I(D,S,Q,A,F,false);M.push("</tr>");if(b.p.grouping){N=X.call(m,M,N,A,z);M=[]}if(h||b.p.treeGrid===true){A._id_=a.jgrid.stripPref(b.p.idPrefix,D);b.p.data.push(A);b.p._index[A._id_]=b.p.data.length-1}if(b.p.gridview===false){a("tbody:first",
c).append(M.join(""));m.triggerHandler("jqGridAfterInsertRow",[D,A,F]);g&&b.p.afterInsertRow.call(b,D,A,F);M=[]}A={};n++;z++;if(n===P)break}}if(b.p.gridview===true){o=b.p.treeANode>-1?b.p.treeANode:0;if(b.p.grouping){m.jqGrid("groupingRender",N,b.p.colModel.length);N=null}else b.p.treeGrid===true&&o>0?a(b.rows[o]).after(M.join("")):a("tbody:first",c).append(M.join(""))}if(b.p.subGrid===true)try{m.jqGrid("addSubGrid",y+G)}catch(T){}b.p.totaltime=new Date-i;if(n>0&&b.p.records===0)b.p.records=E;M=null;
if(b.p.treeGrid===true)try{m.jqGrid("setTreeNode",o+1,n+o+1)}catch(V){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=n;b.p.treeANode=-1;b.p.userDataOnFooter&&m.jqGrid("footerData","set",b.p.userData,true);if(h){b.p.records=E;b.p.lastpage=Math.ceil(E/P)}f||b.updatepager(false,true);if(h)for(;n<E;){F=d[n];D=l(F,n+L);D=b.p.idPrefix+D;if(j.repeatitems){H||(H=v(y+x+G));var $=a.jgrid.getXmlData(F,j.cell,true);a.each(H,function(a){var d=$[this];if(!d)return false;p=d.textContent||d.text;
A[b.p.colModel[a+y+x+G].name]=p})}else for(k=0;k<C.length;k++){p=a.jgrid.getXmlData(F,C[k]);A[b.p.colModel[k+y+x+G].name]=p}A._id_=a.jgrid.stripPref(b.p.idPrefix,D);b.p.data.push(A);b.p._index[A._id_]=b.p.data.length-1;A={};n++}}},C=function(d,c,e,f,g){var i=new Date;if(d){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var h,j=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="jsonstring";if(j){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(b.p.datatype===
"local"){c=b.p.localReader;h="local"}else{c=b.p.jsonReader;h="json"}var l=a(b),k=0,m,o,n,p=[],y=b.p.multiselect?1:0,x=b.p.subGrid===true?1:0,K,G=b.p.rownumbers===true?1:0,u=v(y+x+G);h=t(h);var C,A,D,F={},H,z,E=[],B=b.p.altRows===true?b.p.altclass:"",Q;b.p.page=a.jgrid.getAccessor(d,c.page)||b.p.page||0;A=a.jgrid.getAccessor(d,c.total);x&&(K=a.jgrid.getMethod("addSubGridCell"));b.p.lastpage=A===void 0?1:A;b.p.records=a.jgrid.getAccessor(d,c.records)||0;b.p.userData=a.jgrid.getAccessor(d,c.userdata)||
{};D=b.p.keyIndex===false?a.isFunction(c.id)?c.id.call(b,d):c.id:b.p.keyIndex;if(!c.repeatitems){p=h;if(p.length>0&&!isNaN(D)){b.p.remapColumns&&b.p.remapColumns.length&&(D=a.inArray(D,b.p.remapColumns));D=p[D]}}A=a.jgrid.getAccessor(d,c.root);A==null&&a.isArray(d)&&(A=d);A||(A=[]);d=A.length;o=0;if(d>0&&b.p.page<=0)b.p.page=1;var N=parseInt(b.p.rowNum,10),P=b.p.scroll?a.jgrid.randId():1,L=false,S;g&&(N=N*(g+1));b.p.datatype==="local"&&!b.p.deselectAfterSort&&(L=true);var X=a.isFunction(b.p.afterInsertRow),
J=[],O=false,T;if(b.p.grouping){O=b.p.groupingView.groupCollapse===true;T=a.jgrid.getMethod("groupingPrepare")}for(;o<d;){g=A[o];z=a.jgrid.getAccessor(g,D);if(z===void 0){typeof D==="number"&&b.p.colModel[D+y+x+G]!=null&&(z=a.jgrid.getAccessor(g,b.p.colModel[D+y+x+G].name));if(z===void 0){z=P+o;if(p.length===0&&c.cell){m=a.jgrid.getAccessor(g,c.cell)||g;z=m!=null&&m[D]!==void 0?m[D]:z}}}z=b.p.idPrefix+z;m=e===1?0:e;Q=(m+o)%2===1?B:"";L&&(S=b.p.multiselect?a.inArray(z,b.p.selarrrow)!==-1:z===b.p.selrow);
var $=E.length;E.push("");G&&E.push(s(0,o,b.p.page,b.p.rowNum));y&&E.push(r(z,G,o,S));x&&E.push(K.call(l,y+G,o+e));C=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(C=u)}for(n=0;n<C.length;n++){m=a.jgrid.getAccessor(g,C[n]);F[b.p.colModel[n+y+x+G].name]=m;E.push(q(z,m,n+y+x+G,o+e,g,F))}E[$]=I(z,O,Q,F,g,S);E.push("</tr>");if(b.p.grouping){J=T.call(l,E,J,F,o);E=[]}if(j||b.p.treeGrid===true){F._id_=a.jgrid.stripPref(b.p.idPrefix,z);b.p.data.push(F);b.p._index[F._id_]=
b.p.data.length-1}if(b.p.gridview===false){a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(E.join(""));l.triggerHandler("jqGridAfterInsertRow",[z,F,g]);X&&b.p.afterInsertRow.call(b,z,F,g);E=[]}F={};k++;o++;if(k===N)break}if(b.p.gridview===true){H=b.p.treeANode>-1?b.p.treeANode:0;b.p.grouping?l.jqGrid("groupingRender",J,b.p.colModel.length):b.p.treeGrid===true&&H>0?a(b.rows[H]).after(E.join("")):a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(E.join(""))}if(b.p.subGrid===true)try{l.jqGrid("addSubGrid",
y+G)}catch(V){}b.p.totaltime=new Date-i;if(k>0&&b.p.records===0)b.p.records=d;if(b.p.treeGrid===true)try{l.jqGrid("setTreeNode",H+1,k+H+1)}catch(R){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=k;b.p.treeANode=-1;b.p.userDataOnFooter&&l.jqGrid("footerData","set",b.p.userData,true);if(j){b.p.records=d;b.p.lastpage=Math.ceil(d/N)}f||b.updatepager(false,true);if(j)for(;k<d&&A[k];){g=A[k];z=a.jgrid.getAccessor(g,D);if(z===void 0){typeof D==="number"&&b.p.colModel[D+y+x+G]!=null&&
(z=a.jgrid.getAccessor(g,b.p.colModel[D+y+x+G].name));if(z===void 0){z=P+k;if(p.length===0&&c.cell){e=a.jgrid.getAccessor(g,c.cell)||g;z=e!=null&&e[D]!==void 0?e[D]:z}}}if(g){z=b.p.idPrefix+z;C=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(C=u)}for(n=0;n<C.length;n++)F[b.p.colModel[n+y+x+G].name]=a.jgrid.getAccessor(g,C[n]);F._id_=a.jgrid.stripPref(b.p.idPrefix,z);b.p.data.push(F);b.p._index[F._id_]=b.p.data.length-1;F={}}k++}}},E=function(){function d(a){var b=0,
...
g[b.p.postData.searchField])}catch(t){}}if(b.p.grouping)for(n=0;n<o;n++)p.orderBy(h[n],m.groupOrder[n],i[n].stype,i[n].srcfmt);b.p.multiSort?a.each(c,function(a){p.orderBy(this,e[a],g[this].stype,g[this].srcfmt)}):c&&(b.p.sortorder&&f)&&(b.p.sortorder.toUpperCase()==="DESC"?p.orderBy(b.p.sortname,"d",g[c].stype,g[c].srcfmt):p.orderBy(b.p.sortname,"a",g[c].stype,g[c].srcfmt));var s=p.select(),r=parseInt(b.p.rowNum,10),y=s.length,w=parseInt(b.p.page,10),x=Math.ceil(y/r),v={},s=s.slice((w-1)*r,w*r),
g=p=null;v[b.p.localReader.total]=x;v[b.p.localReader.page]=w;v[b.p.localReader.records]=y;v[b.p.localReader.root]=s;v[b.p.localReader.userdata]=b.p.userData;s=null;return v}}},u=function(){b.grid.hDiv.loading=true;if(!b.p.hiddengrid)switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).show();a("#load_"+a.jgrid.jqID(b.p.id)).show()}},L=function(){b.grid.hDiv.loading=false;switch(b.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(b.p.id)).hide();
break;case "block":a("#lui_"+a.jgrid.jqID(b.p.id)).hide();a("#load_"+a.jgrid.jqID(b.p.id)).hide()}},B=function(d){if(!b.grid.hDiv.loading){var c=b.p.scroll&&d===false,e={},f,g=b.p.prmNames;if(b.p.page<=0)b.p.page=1;if(g.search!==null)e[g.search]=b.p.search;g.nd!==null&&(e[g.nd]=(new Date).getTime());if(g.rows!==null)e[g.rows]=b.p.rowNum;if(g.page!==null)e[g.page]=b.p.page;if(g.sort!==null)e[g.sort]=b.p.sortname;if(g.order!==null)e[g.order]=b.p.sortorder;if(b.p.rowTotal!==null&&g.totalrows!==null)e[g.totalrows]=
b.p.rowTotal;var i=a.isFunction(b.p.loadComplete),h=i?b.p.loadComplete:null,j=0,d=d||1;if(d>1)if(g.npage!==null){e[g.npage]=d;j=d-1;d=1}else h=function(a){b.p.page++;b.grid.hDiv.loading=false;i&&b.p.loadComplete.call(b,a);B(d-1)};else g.npage!==null&&delete b.p.postData[g.npage];if(b.p.grouping){a(b).jqGrid("groupingSetup");var l=b.p.groupingView,k,m="";for(k=0;k<l.groupField.length;k++){var n=l.groupField[k];a.each(b.p.colModel,function(a,b){if(b.name===n&&b.index)n=b.index});m=m+(n+" "+l.groupOrder[k]+
...
case "jsonstring":u();e=typeof b.p.datastr==="string"?a.jgrid.parse(b.p.datastr):b.p.datastr;C(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);i&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;L();break;case "local":case "clientside":u();b.p.datatype="local";e=E();C(e,b.grid.bDiv,o,d>1,j);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);c&&b.grid.populateVisible();
...
"last"+c&&h){b.p.page=d;e=true}e&&B();return false})}b.p.pginput===true&&a("input.ui-pg-input","#"+h).keypress(function(d){if((d.charCode||d.keyCode||0)===13){if(!m("user"))return false;a(this).val(n(a(this).val(),1));b.p.page=a(this).val()>0?a(this).val():b.p.page;B();return false}return this})},Y=function(d){var c,e="",f=b.p.colModel,g=false,i=b.grid.headers[d].el,h="";a("span.ui-grid-ico-sort",i).addClass("ui-state-disabled");a(i).attr("aria-selected","false");if(f[d].lso)if(f[d].lso==="asc"){f[d].lso=
...
cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.localReader);b.p.scroll&&(b.p.pgbuttons=!1,b.p.pginput=!1,b.p.rowList=[]);b.p.data.length&&x();var K="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",G,H,D,S,N,A,z,Q,$=Q="",P=[],ha=[];H=[];if(!0===b.p.shrinkToFit&&!0===b.p.forceFit)for(g=b.p.colModel.length-1;0<=g;g--)if(!b.p.colModel[g].hidden){b.p.colModel[g].resizable=!1;break}"horizontal"===b.p.viewsortcols[1]&&(Q=" ui-i-asc",$=" ui-i-desc");G=
k?"class='ui-th-div-ie'":"";Q="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+Q+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+i+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+$+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+i+"'></span></span>");if(b.p.multiSort){P=b.p.sortname.split(",");for(g=0;g<P.length;g++)H=a.trim(P[g]).split(" "),P[g]=a.trim(H[0]),ha[g]=H[1]?a.trim(H[1]):b.p.sortorder||"asc"}for(g=
0;g<this.p.colNames.length;g++)H=b.p.headertitles?' title="'+a.jgrid.stripHtml(b.p.colNames[g])+'"':"",K+="<th id='"+b.p.id+"_"+b.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+H+">",H=b.p.colModel[g].index||b.p.colModel[g].name,K+="<div id='jqgh_"+b.p.id+"_"+b.p.colModel[g].name+"' "+G+">"+b.p.colNames[g],b.p.colModel[g].width=b.p.colModel[g].width?parseInt(b.p.colModel[g].width,10):150,"boolean"!==typeof b.p.colModel[g].title&&(b.p.colModel[g].title=
!0),b.p.colModel[g].lso="",H===b.p.sortname&&(b.p.lastsort=g),b.p.multiSort&&(H=a.inArray(H,P),-1!==H&&(b.p.colModel[g].lso=ha[H])),K+=Q+"</div></th>";Q=null;a(this).append(K+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var X=[],aa;a("#cb_"+a.jgrid.jqID(b.p.id),this).bind("click",function(){b.p.selarrrow=[];var d=b.p.frozenColumns===true?b.p.id+"_frozen":"";if(this.checked){a(b.rows).each(function(c){if(c>
...
b.p.selrow=null;aa=false}a(b).triggerHandler("jqGridSelectAll",[aa?b.p.selarrrow:X,aa]);a.isFunction(b.p.onSelectAll)&&b.p.onSelectAll.call(b,aa?b.p.selarrrow:X,aa)})}!0===b.p.autowidth&&(K=a(m).innerWidth(),b.p.width=0<K?K:"nw");(function(){var d=0,c=a.jgrid.cell_width?0:n(b.p.cellLayout,0),f=0,g,i=n(b.p.scrollOffset,0),j,l=false,k,m=0,o=0,q;a.each(b.p.colModel,function(){if(this.hidden===void 0)this.hidden=false;if(b.p.grouping&&b.p.autowidth){var e=a.inArray(this.name,b.p.groupingView.groupField);
...
"'>&#160;</div>");a(j).css("width",e.width+"px");var K=a("thead:first",b).get(0),T="";b.p.footerrow&&(T+="<table role='grid' style='width:"+b.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+i+"'>");var j=a("tr:first",K),ba="<tr class='jqgfirstrow' role='row' style='height:auto'>";b.p.disableClick=!1;a("th",j).each(function(d){D=b.p.colModel[d].width;if(b.p.colModel[d].resizable===void 0)b.p.colModel[d].resizable=
true;if(b.p.colModel[d].resizable){S=document.createElement("span");a(S).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(b.p.resizeclass)}else S="";a(this).css("width",D+"px").prepend(S);var c="";if(b.p.colModel[d].hidden){a(this).css("display","none");c="display:none;"}ba=ba+("<td role='gridcell' style='height:0px;width:"+D+"px;"+c+"'></td>");e.headers[d]={width:D,el:this};N=b.p.colModel[d].sortable;if(typeof N!=="boolean")N=b.p.colModel[d].sortable=
...
"</tr>";this.appendChild(document.createElement("tbody"));a(this).addClass("ui-jqgrid-btable").append(ba);var ba=null,j=a("<table class='ui-jqgrid-htable' style='width:"+b.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(K),R=b.p.caption&&!0===b.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>");K=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);
a(g).append(j);j=null;R&&a(e.hDiv).hide();b.p.pager&&("string"===typeof b.p.pager?"#"!==b.p.pager.substr(0,1)&&(b.p.pager="#"+b.p.pager):b.p.pager="#"+a(b.p.pager).attr("id"),a(b.p.pager).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),R&&a(b.p.pager).hide(),V(b.p.pager,""));!1===b.p.cellEdit&&!0===b.p.hoverrows&&a(b).bind("mouseover",function(b){z=a(b.target).closest("tr.jqgrow");a(z).attr("class")!=="ui-subgrid"&&a(z).addClass("ui-state-hover")}).bind("mouseout",
function(b){z=a(b.target).closest("tr.jqgrow");a(z).removeClass("ui-state-hover")});var J,U,fa;a(b).before(e.hDiv).click(function(d){A=d.target;z=a(A,b.rows).closest("tr.jqgrow");if(a(z).length===0||z[0].className.indexOf("ui-state-disabled")>-1||(a(A,b).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==b.id)return this;var c=a(A).hasClass("cbox"),e=a(b).triggerHandler("jqGridBeforeSelectRow",[z[0].id,d]);(e=e===false||e==="stop"?false:true)&&a.isFunction(b.p.beforeSelectRow)&&
(e=b.p.beforeSelectRow.call(b,z[0].id,d));if(!(A.tagName==="A"||(A.tagName==="INPUT"||A.tagName==="TEXTAREA"||A.tagName==="OPTION"||A.tagName==="SELECT")&&!c)&&e===true){J=z[0].id;U=a.jgrid.getCellIndex(A);fa=a(A).closest("td,th").html();a(b).triggerHandler("jqGridCellSelect",[J,U,fa,d]);a.isFunction(b.p.onCellSelect)&&b.p.onCellSelect.call(b,J,U,fa,d);if(b.p.cellEdit===true)if(b.p.multiselect&&c)a(b).jqGrid("setSelection",J,true,d);else{J=z[0].rowIndex;try{a(b).jqGrid("editCell",J,U,true)}catch(f){}}else if(b.p.multikey)if(d[b.p.multikey])a(b).jqGrid("setSelection",
J,true,d);else{if(b.p.multiselect&&c){c=a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+J).is(":checked");a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+J)[b.p.useProp?"prop":"attr"]("checked",c)}}else{if(b.p.multiselect&&b.p.multiboxonly&&!c){var g=b.p.frozenColumns?b.p.id+"_frozen":"";a(b.p.selarrrow).each(function(d,c){var e=b.rows.namedItem(c);a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(c))[b.p.useProp?"prop":"attr"]("checked",false);if(g){a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight");
a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(g))[b.p.useProp?"prop":"attr"]("checked",false)}});b.p.selarrrow=[]}a(b).jqGrid("setSelection",J,true,d)}}}).bind("reloadGrid",function(d,c){if(b.p.treeGrid===true)b.p.datatype=b.p.treedatatype;c&&c.current&&b.grid.selectionPreserver(b);if(b.p.datatype==="local"){a(b).jqGrid("resetSelection");b.p.data.length&&x()}else if(!b.p.treeGrid){b.p.selrow=null;if(b.p.multiselect){b.p.selarrrow=[];O(false)}b.p.savedRow=[]}b.p.scroll&&w.call(b,
true,false);if(c&&c.page){var e=c.page;if(e>b.p.lastpage)e=b.p.lastpage;e<1&&(e=1);b.p.page=e;b.grid.bDiv.scrollTop=b.grid.prevRowHeight?(e-1)*b.grid.prevRowHeight*b.p.rowNum:0}if(b.grid.prevRowHeight&&b.p.scroll){delete b.p.lastpage;b.grid.populateVisible()}else b.grid.populate();b.p._inlinenav===true&&a(b).jqGrid("showAddEditButtons");return false}).dblclick(function(d){A=d.target;z=a(A,b.rows).closest("tr.jqgrow");if(a(z).length!==0){J=z[0].rowIndex;U=a.jgrid.getCellIndex(A);a(b).triggerHandler("jqGridDblClickRow",
[a(z).attr("id"),J,U,d]);a.isFunction(b.p.ondblClickRow)&&b.p.ondblClickRow.call(b,a(z).attr("id"),J,U,d)}}).bind("contextmenu",function(d){A=d.target;z=a(A,b.rows).closest("tr.jqgrow");if(a(z).length!==0){b.p.multiselect||a(b).jqGrid("setSelection",z[0].id,true,d);J=z[0].rowIndex;U=a.jgrid.getCellIndex(A);a(b).triggerHandler("jqGridRightClickRow",[a(z).attr("id"),J,U,d]);a.isFunction(b.p.onRightClickRow)&&b.p.onRightClickRow.call(b,a(z).attr("id"),J,U,d)}});e.bDiv=document.createElement("div");k&&
...
b.rows).each(function(b){a(this).html(g+1+b)});c&&b.p.jqgdnd&&a(b).jqGrid("gridDnD","updateDnD");a(b).triggerHandler("jqGridGridComplete");a.isFunction(b.p.gridComplete)&&b.p.gridComplete.call(b);a(b).triggerHandler("jqGridAfterGridComplete")};b.refreshIndex=x;b.setHeadCheckBox=O;b.constructTr=I;b.formatter=function(a,b,d,c,e){return p(a,b,d,c,e)};a.extend(e,{populate:B,emptyRows:w});this.grid=e;b.addXmlData=function(a){y(a,b.grid.bDiv)};b.addJSONData=function(a){C(a,b.grid.bDiv)};this.grid.cols=
...
true&&a(this).jqGrid("addSubGrid",i+k,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[c,s,s]);C&&this.p.afterInsertRow.call(this,c,s,s);x++;if(this.p.datatype==="local"){y[this.p.localReader.id]=v;this.p._index[v]=this.p.data.length;this.p.data.push(y);y={}}}this.p.altRows===true&&!p&&(d==="last"?(this.rows.length-1)%2===1&&a(this.rows[this.rows.length-1]).addClass(r):a(this.rows).each(function(b){b%2===1?a(this).addClass(r):a(this).removeClass(r)}));this.updatepager(true,
...
-1,i,j;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return g=a,!1}):g=parseInt(e,10),0<=g&&(i=this.rows.namedItem(c)))){var k=a("td:eq("+g+")",i);if(""!==d||!0===h)i=this.formatter(c,d,g,i,"edit"),j=this.p.colModel[g].title?{title:a.jgrid.stripHtml(i)}:{},this.p.treeGrid&&0<a(".tree-wrap",a(k)).length?a("span",a(k)).html(i).attr(j):a(k).html(i).attr(j),"local"===this.p.datatype&&(i=this.p.colModel[g],d=i.formatter&&"string"===typeof i.formatter&&"date"===i.formatter?
a.unformat.date.call(this,d,i):d,j=this.p._index[a.jgrid.stripPref(this.p.idPrefix,c)],void 0!==j&&(this.p.data[j][i.name]=d));"string"===typeof f?a(k).addClass(f):f&&a(k).css(f);"object"===typeof b&&a(k).attr(b)}})},getCell:function(c,e){var d=!1;this.each(function(){var f=-1;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return f=a,!1}):f=parseInt(e,10),0<=f)){var b=this.rows.namedItem(c);if(b)try{d=a.unformat.call(this,a("td:eq("+f+")",b),{rowId:b.id,colModel:this.p.colModel[f]},
f)}catch(h){d=a.jgrid.htmlDecode(a("td:eq("+f+")",b).html())}}});return d},getCol:function(c,e,d){var f=[],b,h=0,g,i,j,e="boolean"!==typeof e?!1:e;void 0===d&&(d=!1);this.each(function(){var k=-1;if(this.grid&&(isNaN(c)?a(this.p.colModel).each(function(a){if(this.name===c)return k=a,!1}):k=parseInt(c,10),0<=k)){var m=this.rows.length,n=0;if(m&&0<m){for(;n<m;){if(a(this.rows[n]).hasClass("jqgrow")){try{b=a.unformat.call(this,a(this.rows[n].cells[k]),{rowId:this.rows[n].id,colModel:this.p.colModel[k]},
k)}catch(o){b=a.jgrid.htmlDecode(this.rows[n].cells[k].innerHTML)}d?(j=parseFloat(b),h+=j,void 0===i&&(i=g=j),g=Math.min(g,j),i=Math.max(i,j)):e?f.push({id:this.rows[n].id,value:b}):f.push(b)}n++}if(d)switch(d.toLowerCase()){case "sum":f=h;break;case "avg":f=h/m;break;case "count":f=m;break;case "min":f=g;break;case "max":f=i}}}});return f},clearGridData:function(c){return this.each(function(){if(this.grid){"boolean"!==typeof c&&(c=!1);if(this.p.deepempty)a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:gt(0)").remove();
else{var e=a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:first")[0];a("#"+a.jgrid.jqID(this.p.id)+" tbody:first").empty().append(e)}this.p.footerrow&&c&&a(".ui-jqgrid-ftable td",this.grid.sDiv).html("&#160;");this.p.selrow=null;this.p.selarrrow=[];this.p.savedRow=[];this.p.records=0;this.p.page=1;this.p.lastpage=0;this.p.reccount=0;this.p.data=[];this.p._index={};this.updatepager(!0,!1)}})},getInd:function(a,e){var d=!1,f;this.each(function(){(f=this.rows.namedItem(a))&&(d=!0===e?f:f.rowIndex)});
return d},bindKeys:function(c){var e=a.extend({onEnter:null,onSpace:null,onLeftKey:null,onRightKey:null,scrollingRows:!0},c||{});return this.each(function(){var d=this;a("body").is("[role]")||a("body").attr("role","application");d.p.scrollrows=e.scrollingRows;a(d).keydown(function(c){var b=a(d).find("tr[tabindex=0]")[0],h,g,i,j=d.p.treeReader.expanded_field;if(b)if(i=d.p._index[a.jgrid.stripPref(d.p.idPrefix,b.id)],37===c.keyCode||38===c.keyCode||39===c.keyCode||40===c.keyCode){if(38===c.keyCode){g=
b.previousSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.previousSibling,!a(g).is(":hidden")&&a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(d).jqGrid("setSelection",h,!0,c);c.preventDefault()}if(40===c.keyCode){g=b.nextSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.nextSibling,!a(g).is(":hidden")&&a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(d).jqGrid("setSelection",h,!0,c);c.preventDefault()}37===c.keyCode&&(d.p.treeGrid&&d.p.data[i][j]&&a(b).find("div.treeclick").trigger("click"),
a(d).triggerHandler("jqGridKeyLeft",[d.p.selrow]),a.isFunction(e.onLeftKey)&&e.onLeftKey.call(d,d.p.selrow));39===c.keyCode&&(d.p.treeGrid&&!d.p.data[i][j]&&a(b).find("div.treeclick").trigger("click"),a(d).triggerHandler("jqGridKeyRight",[d.p.selrow]),a.isFunction(e.onRightKey)&&e.onRightKey.call(d,d.p.selrow))}else 13===c.keyCode?(a(d).triggerHandler("jqGridKeyEnter",[d.p.selrow]),a.isFunction(e.onEnter)&&e.onEnter.call(d,d.p.selrow)):32===c.keyCode&&(a(d).triggerHandler("jqGridKeySpace",[d.p.selrow]),
a.isFunction(e.onSpace)&&e.onSpace.call(d,d.p.selrow))})})},unbindKeys:function(){return this.each(function(){a(this).unbind("keydown")})},getLocalRow:function(c){var e=!1,d;this.each(function(){void 0!==c&&(d=this.p._index[a.jgrid.stripPref(this.p.idPrefix,c)],0<=d&&(e=this.p.data[d]))});return e}})})(jQuery);
...
!0===this.hidden&&a(n).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");j=a.extend({},this.searchoptions||{});if(this.search){if(c.searchOperators){k=j.sopt?j.sopt[0]:"select"===i.stype?"eq":c.defaultSearch;for(var p=0;p<c.odata.length;p++)if(c.odata[p].oper===k){m=c.operands[k]||"";break}k="<a title='"+(null!=j.searchtitle?j.searchtitle:c.operandTitle)+"' style='padding-right: 0.5em;' soper='"+k+"' class='soptclass' colindex='"+f+"'>"+m+"</a>"}a("td:eq(0)",
...
h.append(x);var I=a("<select></select>"),y,C=[];x.append(I);I.bind("change",function(){b.field=a(I).val();s=a(this).parents("tr:first");for(k=0;k<c.p.columns.length;k++)if(c.p.columns[k].name===b.field){t=c.p.columns[k];break}if(t){t.searchoptions.id=a.jgrid.randId();e&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=10);var d=a.jgrid.createEl.call(g,t.inputtype,t.searchoptions,"",!0,c.p.ajaxSelectOptions,!0);a(d).addClass("input-elm");r=t.searchoptions.sopt?t.searchoptions.sopt:
c.p.sopt?c.p.sopt:-1!==a.inArray(t.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;var f="",h=0;C=[];a.each(c.p.ops,function(){C.push(this.oper)});for(k=0;k<r.length;k++)y=a.inArray(r[k],C),-1!==y&&(0===h&&(b.op=c.p.ops[y].oper),f+="<option value='"+c.p.ops[y].oper+"'>"+c.p.ops[y].text+"</option>",h++);a(".selectopts",s).empty().append(f);a(".selectopts",s)[0].selectedIndex=0;a.jgrid.msie&&9>a.jgrid.msiever()&&(f=parseInt(a("select.selectopts",s)[0].offsetWidth,10)+1,a(".selectopts",s).width(f),a(".selectopts",
...
for(k=x=0;k<c.p.columns.length;k++){w=void 0===c.p.columns[k].search?!0:c.p.columns[k].search;var E=!0===c.p.columns[k].hidden;if(!0===c.p.columns[k].searchoptions.searchhidden&&w||w&&!E)w="",b.field===c.p.columns[k].name&&(w=" selected='selected'",x=k),v+="<option value='"+c.p.columns[k].name+"'"+w+">"+c.p.columns[k].label+"</option>"}I.append(v);v=a("<td class='operators'></td>");h.append(v);t=f.columns[x];t.searchoptions.id=a.jgrid.randId();e&&"text"===t.inputtype&&!t.searchoptions.size&&(t.searchoptions.size=
...
r=t.searchoptions.sopt?t.searchoptions.sopt:c.p.sopt?c.p.sopt:-1!==a.inArray(t.searchtype,c.p.strarr)?c.p.stropts:c.p.numopts;v="";a.each(c.p.ops,function(){C.push(this.oper)});for(k=0;k<r.length;k++)y=a.inArray(r[k],C),-1!==y&&(w=b.op===c.p.ops[y].oper?" selected='selected'":"",v+="<option value='"+c.p.ops[y].oper+"'"+w+">"+c.p.ops[y].text+"</option>");u.append(v);v=a("<td class='data'></td>");h.append(v);v.append(x);a.jgrid.bindEv.call(g,x,t.searchoptions);a(x).addClass("input-elm").bind("change",
...
j=0,k,m,n,o=[],p=!1,s="",t;for(t=1;t<=f;t++)s+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!=b&&(p=a(d).jqGrid("getInd",b));a(d.p.colModel).each(function(t){g=this.name;m=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===p)k="";else if(g==d.p.ExpandColumn&&!0===d.p.treeGrid)k=a("td[role='gridcell']:eq("+t+")",d.rows[p]).text();else{try{k=a.unformat.call(d,
a("td[role='gridcell']:eq("+t+")",d.rows[p]),{rowId:b,colModel:this},t)}catch(y){k=this.edittype&&"textarea"==this.edittype?a("td[role='gridcell']:eq("+t+")",d.rows[p]).text():a("td[role='gridcell']:eq("+t+")",d.rows[p]).html()}if(!k||"&nbsp;"==k||"&#160;"==k||1==k.length&&160==k.charCodeAt(0))k=""}var r=a.extend({},this.editoptions||{},{id:g,name:g}),v=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),w=parseInt(v.rowpos,10)||j+1,x=parseInt(2*(parseInt(v.colpos,
...
h=a(e).find("tr[rowpos="+w+"]");if(v.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+v.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=w}0===h.length&&(h=a("<tr "+m+" rowpos='"+w+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(h).append(s),a(e).append(h),h[0].rp=w);a("td:eq("+(x-2)+")",h[0]).html(void 0===v.label?d.p.colNames[t]:v.label);a("td:eq("+(x-1)+")",h[0]).append(v.elmprefix).append(n).append(v.elmsuffix);a.isFunction(r.custom_value)&&"_empty"!==b&&r.custom_value.call(l,
a("#"+g,"#"+q),"set",k);a.jgrid.bindEv.call(l,n,r);o[j]=t;j++}});if(0<j&&(t=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+d.p.id+"_id' value='"+b+"'/></td></tr>"),t[0].rp=j+999,a(e).append(t),c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate))c[l.p.id]._savedData[d.p.id+"_id"]=b;return o}function h(b,d,e){var f,g=0,i,h,j,k,m;if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)c[l.p.id]._savedData=
...
u[j];if(f.status>=300&&f.status!==304){e[0]=false;e[1]=a(l).triggerHandler("jqGridAddEditErrorTextFormat",[f,B]);e[1]=a.isFunction(c[l.p.id].errorTextFormat)?c[l.p.id].errorTextFormat.call(l,f,B):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,B]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(c[l.p.id].afterSubmit)&&(e=c[l.p.id].afterSubmit.call(l,f,u,B))}if(e[0]===false){a("#FormError>td",s).html(e[1]);a("#FormError",s).show()}else{l.p.autoencode&&
...
[b,u,a("#"+q),B]);c[l.p.id].afterComplete.call(l,b,u,a("#"+q),B);b=null},500)}if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate){a("#"+q).data("disabled",false);if(c[l.p.id]._savedData[l.p.id+"_id"]!=="_empty")for(m in c[l.p.id]._savedData)c[l.p.id]._savedData.hasOwnProperty(m)&&u[m]&&(c[l.p.id]._savedData[m]=u[m])}}c[l.p.id].processing=false;a("#sData",s+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+q)[0].focus()}catch(o){}}},a.jgrid.ajaxOptions,c[l.p.id].ajaxEditOptions);!o.url&&
...
!1,w=a.isFunction(c[l.p.id].afterShowForm)?c[l.p.id].afterShowForm:!1,x=a.isFunction(c[l.p.id].beforeInitData)?c[l.p.id].beforeInitData:!1,I=a.isFunction(c[l.p.id].onInitializeForm)?c[l.p.id].onInitializeForm:!1,y=!0,C=1,E=0,u,L,B,q=a.jgrid.jqID(q);"new"===e?(e="_empty",B="add",d.caption=c[l.p.id].addCaption):(d.caption=c[l.p.id].editCaption,B="edit");!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]&&a("#"+a.jgrid.jqID(t.themodal)).remove();var O=!0;d.checkOnUpdate&&(d.jqModal&&!d.modal)&&
(O=!1);if(void 0!==a("#"+a.jgrid.jqID(t.themodal))[0]){y=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(q)),B]);void 0===y&&(y=!0);y&&x&&(y=x.call(l,a("#"+q),B));if(!1===y)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(d.caption);a("#FormError",s).hide();c[l.p.id].topinfo?(a(".topinfo",s).html(c[l.p.id].topinfo),a(".tinfo",s).show()):a(".tinfo",s).hide();c[l.p.id].bottominfo?(a(".bottominfo",s+"_2").html(c[l.p.id].bottominfo),a(".binfo",s+"_2").show()):
a(".binfo",s+"_2").hide();h(e,l,q);"_empty"==e||!c[l.p.id].viewPagerButtons?a("#pData, #nData",s+"_2").hide():a("#pData, #nData",s+"_2").show();!0===c[l.p.id].processing&&(c[l.p.id].processing=!1,a("#sData",s+"_2").removeClass("ui-state-active"));!0===a("#"+q).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide(),a("#"+q).data("disabled",!1));a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),B]);v&&v.call(l,a("#"+q),B);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);
a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,jqM:!1,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});O||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),B]);w&&w.call(l,a("#"+q),B)}else{var V=isNaN(d.dataheight)?d.dataheight:
d.dataheight+"px",y=isNaN(d.datawidth)?d.datawidth:d.datawidth+"px",V=a("<form name='FormPost' id='"+q+"' class='FormGrid' onSubmit='return false;' style='width:"+y+";overflow:auto;position:relative;height:"+V+";'></form>").data("disabled",!1),Y=a("<table id='"+r+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),y=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+q),B]);void 0===y&&(y=!0);y&&x&&(y=x.call(l,a("#"+q,B)));if(!1===y)return;m();a(l.p.colModel).each(function(){var a=
this.formoptions;C=Math.max(C,a?a.colpos||0:0);E=Math.max(E,a?a.rowpos||0:0)});a(V).append(Y);x=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+2*C+"'></td></tr>");x[0].rp=0;a(Y).append(x);x=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*C+"'>"+c[l.p.id].topinfo+"</td></tr>");x[0].rp=0;a(Y).append(x);var y=(x="rtl"==l.p.direction?!0:!1)?"nData":"pData",W=x?"pData":"nData";b(e,l,Y,C);var y="<a href='javascript:void(0)' id='"+y+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+q),B]);I&&I.call(l,a("#"+q),B);"_empty"==e||!c[l.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").hide():a("#pData,#nData",s+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),B]);v&&v.call(l,a("#"+q),B);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});
O||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),B]);w&&w.call(l,a("#"+q),B);a(".fm-button","#"+a.jgrid.jqID(t.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",s+"_2").click(function(){u={};a("#FormError",
...
t="",p=["integer","number","currency"],s=0,r=0,v,w,x;for(o=1;o<=f;o++)t+=1==o?q:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(c.p.colModel).each(function(){i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1;!i&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,p)?s=Math.max(s,parseInt(this.width,10)):r=Math.max(r,parseInt(this.width,10)))});v=0!==s?s:0!==r?r:0;n=a(c).jqGrid("getInd",
b);a(c.p.colModel).each(function(b){g=this.name;w=!1;l=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";x="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&x){k=!1===n?"":g==c.p.ExpandColumn&&!0===c.p.treeGrid?a("td:eq("+b+")",c.rows[n]).text():a("td:eq("+b+")",c.rows[n]).html();w="right"===this.align&&0!==v?!0:!1;var d=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),o=parseInt(d.rowpos,10)||
j+1,q=parseInt(2*(parseInt(d.colpos,10)||1),10);if(d.rowabove){var p=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+d.rowcontent+"</td></tr>");a(e).append(p);p[0].rp=o}h=a(e).find("tr[rowpos="+o+"]");0===h.length&&(h=a("<tr "+l+" rowpos='"+o+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(t),a(e).append(h),h[0].rp=o);a("td:eq("+(q-2)+")",h[0]).html("<b>"+(void 0===d.label?c.p.colNames[b]:d.label)+"</b>");a("td:eq("+(q-1)+")",h[0]).append("<span>"+k+"</span>").attr("id","v_"+g);
...
!1:!0===d.p.colModel[b].hidden?!0:!1;"cb"!==c&&("subgrid"!==c&&"rn"!==c)&&(g=c==d.p.ExpandColumn&&!0===d.p.treeGrid?a(this).text():a(this).html(),a.extend({},d.p.colModel[b].editoptions||{}),c=a.jgrid.jqID("v_"+c),a("#"+c+" span","#"+n).html(g),e&&a("#"+c,"#"+n).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+n).val(b)}function g(b,d){var c=d[1].length-1;0===b?a("#pData","#"+n+"_2").addClass("ui-state-disabled"):void 0!==d[1][b-1]&&a("#"+a.jgrid.jqID(d[1][b-1])).hasClass("ui-state-disabled")?
a("#pData",n+"_2").addClass("ui-state-disabled"):a("#pData","#"+n+"_2").removeClass("ui-state-disabled");b==c?a("#nData","#"+n+"_2").addClass("ui-state-disabled"):void 0!==d[1][b+1]&&a("#"+a.jgrid.jqID(d[1][b+1])).hasClass("ui-state-disabled")?a("#nData",n+"_2").addClass("ui-state-disabled"):a("#nData","#"+n+"_2").removeClass("ui-state-disabled")}function i(){var b=a(j).jqGrid("getDataIDs"),d=a("#id_g","#"+n).val();return[a.inArray(d,b),b]}var j=this;if(j.grid&&e){var k=j.p.id,m="ViewGrid_"+a.jgrid.jqID(k),
...
extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,mtype:"POST"},a.jgrid.inlineEdit,k);return this.each(function(){var b=this,d,e,f,g=0,i=null,h={},j,m;b.grid&&(j=a(b).jqGrid("getInd",c,!0),!1!==j&&(f=a(j).attr("editable")||"0","0"==f&&!a(j).hasClass("not-editable-row")&&(m=b.p.colModel,a('td[role="gridcell"]',j).each(function(f){d=m[f].name;var j=!0===b.p.treeGrid&&d===b.p.ExpandColumn;if(j)e=a("span:first",this).html();else try{e=a.unformat.call(b,this,{rowId:c,
colModel:m[f]},f)}catch(k){e=m[f].edittype&&"textarea"===m[f].edittype?a(this).text():a(this).html()}if("cb"!==d&&("subgrid"!==d&&"rn"!==d)&&(b.p.autoencode&&(e=a.jgrid.htmlDecode(e)),h[d]=e,!0===m[f].editable)){null===i&&(i=f);j?a("span:first",this).html(""):a(this).html("");var p=a.extend({},m[f].editoptions||{},{id:c+"_"+d,name:d});m[f].edittype||(m[f].edittype="text");if("&nbsp;"===e||"&#160;"===e||1===e.length&&160===e.charCodeAt(0))e="";var t=a.jgrid.createEl.call(b,m[f].edittype,p,e,!0,a.extend({},
a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(t).addClass("editable");j?a("span:first",this).append(t):a(this).append(t);a.jgrid.bindEv.call(b,t,p);"select"===m[f].edittype&&(void 0!==m[f].editoptions&&!0===m[f].editoptions.multiple&&void 0===m[f].editoptions.dataUrl&&a.jgrid.msie)&&a(t).width(a(t).width());g++}}),0<g&&(h.id=c,b.p.savedRow.push(h),a(j).attr("editable","1"),a("td:eq("+i+") input",j).focus(),!0===k.keys&&a(j).bind("keydown",function(d){if(27===d.keyCode){a(b).jqGrid("restoreRow",
...
a(d).jqGrid("collapseNode",d.p.data[e])}else{a(d).jqGrid("expandRow",d.p.data[e]);a(d).jqGrid("expandNode",d.p.data[e])}a(d).jqGrid("setSelection",c);return false}),c++})},setTreeGrid:function(){return this.each(function(){var c=this,e=0,d,f=!1,b,h,g=[];if(c.p.treeGrid){c.p.treedatatype||a.extend(c.p,{treedatatype:c.p.datatype});c.p.subGrid=!1;c.p.altRows=!1;c.p.pgbuttons=!1;c.p.pginput=!1;c.p.gridview=!0;null===c.p.rowTotal&&(c.p.rowNum=1E4);c.p.multiselect=!1;c.p.rowList=[];c.p.expColInd=0;d="ui-icon-triangle-1-"+
("rtl"==c.p.direction?"w":"e");c.p.treeIcons=a.extend({plus:d,minus:"ui-icon-triangle-1-s",leaf:"ui-icon-radio-off"},c.p.treeIcons||{});"nested"==c.p.treeGridModel?c.p.treeReader=a.extend({level_field:"level",left_field:"lft",right_field:"rgt",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded",icon_field:"icon"},c.p.treeReader):"adjacency"==c.p.treeGridModel&&(c.p.treeReader=a.extend({level_field:"level",parent_id_field:"parent",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded",
icon_field:"icon"},c.p.treeReader));for(b in c.p.colModel)if(c.p.colModel.hasOwnProperty(b))for(h in d=c.p.colModel[b].name,d==c.p.ExpandColumn&&!f&&(f=!0,c.p.expColInd=e),e++,c.p.treeReader)c.p.treeReader.hasOwnProperty(h)&&c.p.treeReader[h]==d&&g.push(d);a.each(c.p.treeReader,function(b,d){if(d&&a.inArray(d,g)===-1){if(b==="leaf_field")c.p._treeleafpos=e;e++;c.p.colNames.push(d);c.p.colModel.push({name:d,width:1,hidden:true,sortable:false,resizable:false,hidedlg:true,editable:true,search:false})}})}})},
...
r.displayValue,n[r.idx],r.value)}catch(s){m=r.displayValue}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+f.p.direction+" "+j+'"><td style="padding-left:'+12*r.idx+'px;" colspan="'+e+'">'+g+a.jgrid.template(b.groupText[r.idx],m,r.cnt,r.summary)+"</td></tr>";if(o-1===r.idx){var t=b.groups[q+1],v,w,x=void 0!==t?b.groups[q+1].startRow:c.length;for(w=r.startRow;w<x;w++)h+=c[w].join("");var I;if(void 0!==t){for(I=0;I<b.groupField.length&&t.dataIndex!==b.groupField[I];I++);l=b.groupField.length-
I}for(t=0;t<l;t++)if(p[t]){w="";b.groupCollapse&&!b.showSummaryOnHide&&(w=' style="display:none;"');h+="<tr"+w+' jqfootlevel="'+(r.idx-t)+'" role="row" class="ui-widget-content jqfoot ui-row-'+f.p.direction+'">';w=d(q,t,b.groups);var y=f.p.colModel,C,E=w.cnt;for(v=0;v<e;v++){var u="<td "+f.formatCol(v,1,"")+">&#160;</td>",L="{0}";a.each(w.summary,function(){if(this.nm===y[v].name){y[v].summaryTpl&&(L=y[v].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&(this.v&&0<E)&&(this.v/=
E);try{C=f.formatter("",this.v,v,this)}catch(b){C=this.v}u="<td "+f.formatCol(v,1,"")+">"+a.jgrid.format(L,C)+"</td>";return!1}});h+=u}h+="</tr>"}l=I}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);h=null})},groupingGroupBy:function(c,e){return this.each(function(){"string"===typeof c&&(c=[c]);var d=this.p.groupingView;this.p.grouping=!0;void 0===d.visibiltyOnNextGrouping&&(d.visibiltyOnNextGrouping=[]);var f;for(f=0;f<d.groupField.length;f++)!d.groupColumnShow[f]&&d.visibiltyOnNextGrouping[f]&&
